...
% INO - matrix felbontás az INO feltétel szerint
%
% [IP,BASE]=INO(U)
% 
% Az U matrix nxr-es, n>r és SN, azaz a sorok összege
% 1 kell legyen;
% 
% A kimenet az nxr-es IP és az rxr-es BASE matrix, ahol
...
%ip=UU*inv(RNO); %az interpolációs matrix
ip = UU*inv(cs);  %az interpolációs matrix
